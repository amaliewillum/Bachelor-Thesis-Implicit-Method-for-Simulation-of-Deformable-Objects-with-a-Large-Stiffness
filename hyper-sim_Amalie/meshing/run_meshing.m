...
%   fd = @(p) dbox(p,10.0,4.0,4.0);
  [p, T] = distmeshnd(fd,@huniform,min_edge_length,[-8,-8.5,-8.5;8,8.5,8.5],[]); %[-6,-3,-3;6,3,3]
%   [-0.85,-0.37,-0.37;0.85,0.37,0.37]
  ...
  display(strcat( 'X =', [' ',num2str(length(X))] ) );
